 ...
 *
 * Modified by Stuart Watt to pass the username as well as the domain-added
 * username to the template generator. This is needed to make stuff work better
 * on servers where userPrincipalName no longer matches the domain, and
 * other equivalent fields use the username directly.
 *
 * @author Luke Taylor
 * @author Rob Winch
 * @since 3.1
 */
public final class CustomLdapAuthenticationProvider extends
    ...
    private void raiseExceptionForErrorCode(int code, NamingException exception) {
        ...
        Throwable cause = new CustomLdapAuthenticationException(hexString,
